...
3. Shows a **main menu** (Sessions, Search, Project Stats, Clean empty sessions, Switch provider, Quit)
...
```
main.go → internal/tui/ → internal/actions/ → internal/session/ → internal/provider/ → pkg/types/
```
